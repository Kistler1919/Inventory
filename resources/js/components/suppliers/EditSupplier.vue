<template>
  <div>
    <div class="row justify-content-center">
      <router-link to="/suppliers" class="btn btn-primary"> List all suppliers</router-link>
    </div>
    <div class="row justify-content-center">
              ...
              <div class="col-lg-12">
                <div class="login-form">
                  <div class="text-center">
                    <h1 class="h4 text-gray-700 mb-4">Edit/Update Supplier Details</h1>
                  </div>
...
export default {
  ...
  methods: {
    ...
    updateSupplier() {
      let id = this.$route.params.id
      axios.patch('/api/v1/suppliers/'+id, this.form)
        .then(() => {
